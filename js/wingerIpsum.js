...
Season 6 Coming soon to Yahoo! Screen
@CommunityTV
#sixseasonsandamovie
*/
...
function getWingers() {
    $(document).ready(function () {
        ...
        if (wingersHeader != "") {
			...
			wingersArray[10] = "Why is there hot sauce in the bathroom? It's Greendale!";
			wingersArray[11] = "Thanks a lot, Francis Ford Repo Man.";
			wingersArray[12] = "Improving Greendale takes more than ideas, Annie, it takes time, gasoline, matches..."
			wingersArray[13] = "Oh look, Indiana Jones and the Apartment of Perpetual Virginity.";
...
//Haven't you humilated me enough?  At least I got some actual developers to look at this code.  I didn't take jQuery because no one told me it was being offered spring quarter at my COMMUNITY COLLEGE.