        ...
        $("#getWingers").click(function(){
            ...
            //'if' statement checking for header request. "No" has no value.
                if (wingersHeader.val() != ""){
                    ...
                    } //End code checking and adding a header?  (Not sure what this does anymore.)
							 

					
                }//End "if" statement checking for old code.		
